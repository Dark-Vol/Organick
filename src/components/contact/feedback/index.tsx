    ...
    <section className="feedback">
      <div className="container">
        <div className="feedback__content">
          <img
            className="feedback__content-img"
            src="/img/Feedback/Feedback-min.jpg"
            alt="PasswordProtected"
            loading="lazy"
          />

          <div className="feedback__content-info">
            <div className="feedback__content-info-title">
              <h2 className="feedback__content-info-title-heading">
                Let's Find Out. Where Our Organic Farms Located.
              </h2>

              <p className="feedback__content-info-title-subheading">
                Please contact us using the information below. To locate,
                contact us in the nearest organic store or office closest to
                you, visit our office websites.
              </p>
            </div>

            <div className="feedback__content-info-items">
              <div className="feedback__content-info-items-item">
                <img
                  className="feedback__content-info-items-item-img"
                  src="/img/Feedback/Massege-min.jpg"
                  alt="feedback-massege"
                />

                <div className="feedback__content-info-items-item-layout">
                  <h2 className="feedback__content-info-items-item-layout-label">
                    Email
                  </h2>

                  <Link
                    to="mailto:needhelp@Organia.com"
                    className="feedback__content-info-items-item-layout-link"
                  >
            ...
            <div className="feedback__content-info-items">
              <div className="feedback__content-info-items-item">
                <img
                  className="feedback__content-info-items-item-img"
                  src="/img/Feedback/Number-min.jpg"
                  alt="feedback-number"
                />
                <div className="feedback__content-info-items-item-layout">
                  <h2 className="feedback__content-info-items-item-layout-label">
            ...
            <ul className="items items_feedback">
              ...
              <li className="items__item">
                <Link
                  ...
                  target="_blank"
                >
                  <svg width="20" height="20" viewBox="0 0 21 18" fill="none">
                    <path
